				...
				<div class="search-bar-wrap">		
       			...
       			<div class="filter-content">
     				...
     				<div class="home-type mb-4">
                        ...
                        <div class="form-check form-check-inline">
                           	<input type="checkbox" class="form-check-input" autocomplete="off" name="homeType" value="M">
			 				<label class="form-check-label" >쓰리룸이상 </label>
                        </div>
                        <div class="form-check form-check-inline">
                         	<input type="checkbox" class="form-check-input" autocomplete="off" name="homeType" value="OH">
					...
					<hr>
     				...
     				<div class="addInfo-list mb-3">
     					<div class="form-check form-check-inline">
                           	<input type="checkbox" class="form-check-input" autocomplete="off" name="addInfoList" value="pet">
							<label class="form-check-label">반려동물</label>
						</div>
                        <div class="form-check form-check-inline">
                        	<input type="checkbox" class="form-check-input"  autocomplete="off" name="addInfoList" value="elevator">
 							<label class="form-check-label">엘리베이터</label>
                        </div>
                        <div class="form-check form-check-inline">
                        	<input type="checkbox" class="form-check-input"  autocomplete="off" name="addInfoList" value="parking">
 							<label class="form-check-label">주차 가능</label>
                        </div>
                        <div class="form-check form-check-inline mb-3">
                        	<input type="checkbox" class="form-check-input"  autocomplete="off" name="addInfoList" value="balcony">
