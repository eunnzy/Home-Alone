                   ...
                   <tbody>
                       ...
                       <tr>
                           ...
                           <td>
                           		<div class="row mb-3">
									<div class="col-auto">
										 <input class="form-control" type="text" name="floor" placeholder="해당 층" value="${home.floor}">  
									</div>    
									<div class="col-auto">
								   		/
							    	</div>                        	
								    <div class="col-auto">
								   		<input class="form-control" type="text" name="totalFloor" placeholder="전체 층" value="${home.totalFloor}">
							    	</div>
						    		<div class="col-auto">
