   ...
   <div class="container">
    <div class="bs-docs-section row">
     <div class="col-lg-12"><br><br>
       <h1 id="tables">공지사항 수정</h1>
       
     <form action="/admin/updateAlarm.do" method="post" enctype="multipart/form-data" id="modifyForm">
	...
	<script type="text/javascript" src="/js/Alarmboard_modify_Attach.js"></script>
</body>
</html>