...
<head>
    ...
    <link href="/css/memberJoin.css?after" rel="stylesheet"></link>
...
<body>
		...
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto">
				<form id="imcha-form" method="post">
					<h1 class="text-center mb-3">회원 정보 수정</h1>
					<div class="row">
					
						<div class="mb-3">
							<label for="id_name">아이디</label>
							<div class="id_input_box">
								<input type="text" class="form-control" name="imchaId" id="imchaId" value="${imcha.imchaId}" required readonly>
							</div>
						</div>
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control" name="name" id="name" placeholder="" value="${imcha.name }" readonly> 									
						...
						<div class="d-grid gap-2">
							<button class="btn btn-primary" id="modifyBtn" type="submit">정보수정</button>
	...
	<script src="/js/member/modifyImcha.js"></script>
	...
	$('document').ready(function() {
		 ...
		 $("select[name^=sido]").change(function() {
			 ...
			 let gugun = $(this).parent().next().children(); // 선택영역 군구 객체
