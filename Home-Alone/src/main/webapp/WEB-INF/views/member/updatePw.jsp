                     ...
                     <form action="${pageContext.request.contextPath }/member/updatePw" id="updatePw" method="post" name="updatePw">
                         <div class="row">
                             <div class="col-12 mb-4">
                                 ...
                                 <input type="text" name="imchaId" class="form-control" id="imchaId" value="${findPwVo.imchaId }" readonly>
                             </div>
                             <br>
                         <div class="col-12 mb-4">
                                <label for="phone_number">New Password</label>
                                <input type="password" name="imchaPw" class="password form-control" id="imchaPw" min="0" value="" placeholder="새로운 비밀번호를 입력하세요.">
                         <div class="passdiv"></div>
                         </div>
                         <div class="col-12 mb-4">
                               	<label for="phone_number">Password Check</label>
                                <input type="password" name="imchaPw1" class="password2 form-control" id="imchaPw1" min="0" value="" placeholder="비밀번호를 재입력하세요.">
