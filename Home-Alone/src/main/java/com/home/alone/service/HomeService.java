...
public interface HomeService {
	...
	List<HomeOverviewVO> homeInBoundsList(Map<String, Object> mapBounds);	// 지도 경계 내 매물 리스트
	List<HomeOverviewVO> homeListByFilter(Map<String, Object> filterData);	// 매물 필터 검색
	...
	List<HomeOverviewVO> getListByLessorId(LessorVO vo);	// 중개인이 등록한 매물 리스트
