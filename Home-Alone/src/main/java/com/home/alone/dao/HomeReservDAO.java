...
public interface HomeReservDAO {
	...
	List<HomeReservOverviewVO> selectHomeReservListByImchaId(String imchaId);	// 일반회원 예약 목록
	List<HomeReservOverviewVO> selectHomeReservListByLessorId(String lessorId);	// 일반회원 예약 목록
